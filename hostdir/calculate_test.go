...
func TestCalculateDeploy(t *testing.T) {
	...
	req = plugintypes.WorkloadResourceRequest{
		"volumes": []string{
			fmt.Sprintf("/eru/img0:/dir0:%v", units.GiB),
			fmt.Sprintf("/eru/img1:/dir1:%v", units.GiB),
		},
	}
...
func TestCalculateRealloc(t *testing.T) {
	...
	bindings, err := types.NewVolumeBindings([]string{
		"/eru/img0:/dir0:100GiB",
		"/eru/img1:/dir1:100GiB",
		"/eru/img2:/dir2:1TB",
	})
	assert.NoError(t, err)
	...
	// 1. Add one
	req = plugintypes.WorkloadResourceRequest{
		"volume-request": []string{"/eru/img1:/dir1:100GiB"},
	}
